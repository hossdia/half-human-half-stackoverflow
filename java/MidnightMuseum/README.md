...
**Midnight Museum** is a text-based horror adventure game built in Java.
...
* Curator's Handbook & anomaly protocols
...
```bash
git clone https://github.com/hossdia/half-human-half-stackoverflow.git
```
